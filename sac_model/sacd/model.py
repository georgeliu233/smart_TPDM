...
class TwinnedQNetwork(BaseNetwork):
    def __init__(self, num_channels, num_actions, shared=False,
                 dueling_net=False,cnn=False):
        super().__init__()
        self.Q1 = QNetwork(num_channels, num_actions, shared, dueling_net,cnn)
        self.Q2 = QNetwork(num_channels, num_actions, shared, dueling_net,cnn)
...
class CateoricalPolicy(BaseNetwork):
    ...
    def __init__(self, num_channels, num_actions, shared=False,cnn=False):
        super().__init__()
        if cnn:
            self.conv = DQNBase(num_channels)
            out_dim = 7*7*64
