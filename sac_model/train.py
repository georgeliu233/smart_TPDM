...
agent = SacdAgent(env,test_env=None,log_dir=log_dir,num_steps=100000,batch_size=64,
                memory_size=50000,start_steps=2000,update_interval=1,target_update_interval=1000,
                use_per=True,dueling_net=True,max_episode_steps=1000,multi_step=3)
agent.run()
